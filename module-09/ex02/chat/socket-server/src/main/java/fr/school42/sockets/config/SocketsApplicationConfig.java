...
import fr.school42.sockets.repositories.RoomsRepositoryImpl;
...
import fr.school42.sockets.services.RoomsServiceImpl;
...
public class SocketsApplicationConfig {
    ...
    public Server server() {
        ...
        return new Server(usersService(), messagesService(), roomsService());
    }
    ...
    public RoomsService roomsService() {
        ...
        return new RoomsServiceImpl(roomsRepository());
    }
}
