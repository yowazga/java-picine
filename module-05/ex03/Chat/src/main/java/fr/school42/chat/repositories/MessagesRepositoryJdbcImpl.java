...
/*   Updated: 2025/05/16 17:46:00 by Younes           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public class MessagesRepositoryJdbcImpl implements MessagesRepository {
    ...
    private void setUpdateParameters(PreparedStatement statement, Message message) throws SQLException {
    ...
    public void update(Message message) {
        ...
        validateMessageForUpdate(message);
        ...
        try (Connection connection = dataSource.getConnection();
             PreparedStatement statement = connection.prepareStatement(sql)) {
                ...
                setUpdateParameters(statement, message);
                executeUpdate(statement);
            
        } catch (SQLException e) {
            e.printStackTrace();
            throw new RuntimeException("Failed ot update message" + e);
        }
    }
